...
def draw_game(act, record, result):
    ...
    # once game started, shot hit and stand buttons and win/loss records
        ...
        hit = pygame.draw.rect(screen, 'white', [0, 700, 150, 50], 0, 5)
        pygame.draw.rect(screen, 'green', [0, 700, 150, 50], 3, 5)
        hit_text = font.render('HIT ME', True, 'black')
        screen.blit(hit_text, (35, 715)) #### hit text position
        button_list.append(hit)
        stand = pygame.draw.rect(screen, 'white', [300, 700, 150, 50], 0, 5)
        pygame.draw.rect(screen, 'green', [300, 700, 150, 50], 3, 5)
        stand_text = font.render('STAND', True, 'black')
        screen.blit(stand_text, (340, 715))
